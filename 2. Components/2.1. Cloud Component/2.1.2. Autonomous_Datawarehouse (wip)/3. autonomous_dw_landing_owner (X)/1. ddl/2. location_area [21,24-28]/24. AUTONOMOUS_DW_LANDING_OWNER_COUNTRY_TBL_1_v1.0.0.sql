...
IF v_count > 0 THEN
    EXECUTE IMMEDIATE 'DROP TABLE autonomous_dw_landing_owner.dwh_country CASCADE CONSTRAINTS';
END IF;
--CREATE DWH_COUNTRY TABLE;
v_sql := q'[
        CREATE TABLE autonomous_dw_landing_owner.dwh_country (
          --business columns
...
EXECUTE IMMEDIATE 'GRANT SELECT ON autonomous_dw_landing_owner.dwh_country TO autonomous_db_out_owner';
...
-- TABLE COMMENT
EXECUTE IMMEDIATE 'COMMENT ON TABLE autonomous_dw_landing_owner.dwh_country IS ''This table will contains the information about countries like Romania, Bulgaria, Italia, etc''';

-- BUSINESS COLUMNS
EXECUTE IMMEDIATE 'COMMENT ON COLUMN autonomous_dw_landing_owner.dwh_country.country_id IS ''The id of the country''';
EXECUTE IMMEDIATE 'COMMENT ON COLUMN autonomous_dw_landing_owner.dwh_country.name IS ''The name of the country''';
EXECUTE IMMEDIATE 'COMMENT ON COLUMN autonomous_dw_landing_owner.dwh_country.code IS ''The code of the country''';
EXECUTE IMMEDIATE 'COMMENT ON COLUMN autonomous_dw_landing_owner.dwh_country.population IS ''The population of the country''';
EXECUTE IMMEDIATE 'COMMENT ON COLUMN autonomous_dw_landing_owner.dwh_country.area IS ''The area of the country''';
EXECUTE IMMEDIATE 'COMMENT ON COLUMN autonomous_dw_landing_owner.dwh_country.time_zone IS ''The time zone of the country''';
EXECUTE IMMEDIATE 'COMMENT ON COLUMN autonomous_dw_landing_owner.dwh_country.unemployment_rate IS ''The unemployment rate of the country ''';
EXECUTE IMMEDIATE 'COMMENT ON COLUMN autonomous_dw_landing_owner.dwh_country.inflation_rate IS ''The inflation rate of the country''';
EXECUTE IMMEDIATE 'COMMENT ON COLUMN autonomous_dw_landing_owner.dwh_country.average_monthly_salary IS ''The average monthly salary of the country''';
EXECUTE IMMEDIATE 'COMMENT ON COLUMN autonomous_dw_landing_owner.dwh_country.corporate_tax_rate IS ''The corporate tax of the country''';
EXECUTE IMMEDIATE 'COMMENT ON COLUMN autonomous_dw_landing_owner.dwh_country.rating IS ''The rating of the country''';
EXECUTE IMMEDIATE 'COMMENT ON COLUMN autonomous_dw_landing_owner.dwh_country.region_id IS ''The region id of the country''';
EXECUTE IMMEDIATE 'COMMENT ON COLUMN autonomous_dw_landing_owner.dwh_country.official_lang_code IS ''The code of the official language of the country''';
EXECUTE IMMEDIATE 'COMMENT ON COLUMN autonomous_dw_landing_owner.dwh_country.currency_code IS ''The currency code of the country''';
--TECHNOCAL COLUMNS
