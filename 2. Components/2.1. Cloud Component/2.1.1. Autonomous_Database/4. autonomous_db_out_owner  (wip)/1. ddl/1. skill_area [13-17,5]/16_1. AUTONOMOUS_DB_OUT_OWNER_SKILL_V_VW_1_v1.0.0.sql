--AUTONOMOUS_DB_OUT_OWNER_SKILL_V_VW_1_v1.0.0
--"SKILL_V VIEW"
SET SERVEROUTPUT ON;
DECLARE
  v_count NUMBER;
...
AND view_name = 'SKILL_V';
IF v_count > 0 THEN
    EXECUTE IMMEDIATE 'DROP VIEW autonomous_db_out_owner.skill_v CASCADE CONSTRAINTS';
END IF;
...
AND view_name = 'SKILL_V';
IF v_count = 0 THEN
    RAISE_APPLICATION_ERROR(-20001,'The SKILL_V view wasnt created properly.');
END IF;
DBMS_OUTPUT.PUT_LINE('[2.] The SKILL_V view was created.');
