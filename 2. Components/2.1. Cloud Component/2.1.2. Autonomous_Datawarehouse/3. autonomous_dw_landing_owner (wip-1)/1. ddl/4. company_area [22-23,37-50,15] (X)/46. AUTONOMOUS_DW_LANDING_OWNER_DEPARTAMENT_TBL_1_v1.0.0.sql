--AUTONOMOUS_DW_LANDING_OWNER_DWH_DEPARTMENT_TBL_1_v1.0.0
--"DWH_DEPARTMENT TABLE"
SET SERVEROUTPUT ON;
DECLARE
  v_count NUMBER;
...
AND tablespace_name = 'DATA';
IF v_count = 0 THEN
    RAISE_APPLICATION_ERROR(-20001,'The DWH_DEPARTMENT table wasnt created properly.');
END IF;
