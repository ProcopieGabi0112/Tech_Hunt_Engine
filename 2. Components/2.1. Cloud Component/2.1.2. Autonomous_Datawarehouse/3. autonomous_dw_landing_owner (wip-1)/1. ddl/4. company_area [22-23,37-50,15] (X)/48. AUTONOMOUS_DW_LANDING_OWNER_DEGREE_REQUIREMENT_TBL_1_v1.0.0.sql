--AUTONOMOUS_DW_LANDING_OWNER_DWH_DEGREE_REQUIREMENT_TBL_1_v1.0.0
--"DWH_DEGREE_REQUIREMENT TABLE"
SET SERVEROUTPUT ON;
DECLARE
  v_count NUMBER;
...
--DELETE TABLE DWH_DEGREE_REQUIREMENT IF EXIST;
SELECT COUNT(*) INTO v_count
FROM all_tables
...
AND tablespace_name = 'DATA';
IF v_count = 0 THEN
    RAISE_APPLICATION_ERROR(-20001,'The DWH_DEGREE_REQUIREMENT table wasnt created properly.');
END IF;
