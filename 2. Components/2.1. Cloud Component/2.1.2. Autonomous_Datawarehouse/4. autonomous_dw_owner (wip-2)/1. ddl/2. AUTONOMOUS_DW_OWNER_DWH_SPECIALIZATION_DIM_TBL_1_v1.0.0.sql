...
-- TABLE COMMENT
EXECUTE IMMEDIATE 'COMMENT ON TABLE  autonomous_dw_owner.dwh_specialization_dim IS ''The table contains location of the institution where students graduate.''';
-- BUSINESS COLUMNS COMMENT                              
EXECUTE IMMEDIATE 'COMMENT ON COLUMN autonomous_dw_owner.dwh_specialization_dim.specialization_key IS ''The Surrogate key of the table''';
EXECUTE IMMEDIATE 'COMMENT ON COLUMN autonomous_dw_owner.dwh_specialization_dim.location_address_code IS ''The primary key from source system''';
EXECUTE IMMEDIATE 'COMMENT ON COLUMN autonomous_dw_owner.dwh_specialization_dim.location_address IS ''The full address of the location''';
EXECUTE IMMEDIATE 'COMMENT ON COLUMN autonomous_dw_owner.dwh_specialization_dim.postal_code IS ''The postal code of the address''';
EXECUTE IMMEDIATE 'COMMENT ON COLUMN autonomous_dw_owner.dwh_specialization_dim.location_details IS ''The details of the location address''';
EXECUTE IMMEDIATE 'COMMENT ON COLUMN autonomous_dw_owner.dwh_specialization_dim.city_name IS ''The name of the city of location address.''';
EXECUTE IMMEDIATE 'COMMENT ON COLUMN autonomous_dw_owner.dwh_specialization_dim.capital_city_flag IS ''The flag indicating if the city is the capital''';
EXECUTE IMMEDIATE 'COMMENT ON COLUMN autonomous_dw_owner.dwh_specialization_dim.city_position IS ''The geographical position of the location address''';
EXECUTE IMMEDIATE 'COMMENT ON COLUMN autonomous_dw_owner.dwh_specialization_dim.city_stats IS ''The city stats of location address''';
EXECUTE IMMEDIATE 'COMMENT ON COLUMN autonomous_dw_owner.dwh_specialization_dim.administrative_unit_name IS ''The name of the administrative unit of the location address''';
EXECUTE IMMEDIATE 'COMMENT ON COLUMN autonomous_dw_owner.dwh_specialization_dim.administrative_unit_stats IS ''The administrative unit stats of location address''';
EXECUTE IMMEDIATE 'COMMENT ON COLUMN autonomous_dw_owner.dwh_specialization_dim.country_name IS ''The country name of location address''';
EXECUTE IMMEDIATE 'COMMENT ON COLUMN autonomous_dw_owner.dwh_specialization_dim.country_stats IS ''The country stats of location address''';
EXECUTE IMMEDIATE 'COMMENT ON COLUMN autonomous_dw_owner.dwh_specialization_dim.country_rating IS ''The country rating of location address''';
EXECUTE IMMEDIATE 'COMMENT ON COLUMN autonomous_dw_owner.dwh_specialization_dim.official_language_name IS ''The name of the official language from that location''';
EXECUTE IMMEDIATE 'COMMENT ON COLUMN autonomous_dw_owner.dwh_specialization_dim.currency_name IS ''The name of the currency from that location''';
EXECUTE IMMEDIATE 'COMMENT ON COLUMN autonomous_dw_owner.dwh_specialization_dim.region_name IS ''The name of the region from that location''';
...
INSERT INTO autonomous_dw_owner.dwh_specialization_dim (
