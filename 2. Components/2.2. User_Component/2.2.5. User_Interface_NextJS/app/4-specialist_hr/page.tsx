...
export default function HrDashboard() {
  ...
  // Typed text effect
  const message =
    "Find the right talent. Build strong teams. Shape the future of your company.";
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-purple-50 via-indigo-50 to-blue-50 text-black flex flex-col">
      ...
      flex items-center justify-between px-10 fixed top-0 z-50 shadow-md">
        ...
        <div className="flex-1 flex justify-center">
          <div className="flex gap-10 text-lg font-semibold">
            <button onClick={() => router.push("/4-specialist_hr/profile")} className="hover:text-indigo-600">
              Profile
            </button>
            <button onClick={() => router.push("/4-specialist_hr/applications")} className="hover:text-indigo-600">
              Applications
            </button>
            <button onClick={() => router.push("/4-specialist_hr/jobs")} className="hover:text-indigo-600">
              Jobs
            </button>
            </div>
        </div>
          ...
          {showProfileMenu && (
            <div className="absolute right-0 top-16 bg-white text-black shadow-lg rounded-lg w-48 py-2 z-50">
              ...
              <div
                ...
                onClick={() => router.push("/4-specialist_hr/profile")}
              >
                View Profile
              </div>
